...
const formSchema = z.object({
  ...
  confirm_password: z.string()
    .min(12, { message: "La confirmación de contraseña debe tener al menos 12 caracteres." }),
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <div className="text-xs text-muted-foreground mt-1">
                  La contraseña debe tener al menos 12 caracteres, incluir mayúsculas, minúsculas, números y símbolos.
                </div>
                <FormMessage />
              </FormItem>
            )}
