...
export function LoginForm() {
  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border border-gray-200 w-full max-w-[90%] sm:max-w-md mx-auto">
      <div className="flex flex-col items-center mb-4">
        <img src="/images/logo.png" alt="Logo" className="h-16 w-16 mb-2" />
        <h2 className="text-xl sm:text-2xl font-bold mb-2 text-center text-foreground">Iniciar sesión</h2>
        <p className="text-sm text-muted text-center">Accede a tu cuenta</p>
      </div>
      <Form {...form}>
        <form
